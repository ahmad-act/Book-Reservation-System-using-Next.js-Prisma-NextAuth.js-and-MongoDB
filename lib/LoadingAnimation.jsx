...
const LoadingAnimation = () => {
    return (
        <div aria-label="Loading..." role="status" className="flex items-center space-x-2 text-purple-800">
            <svg className="h-20 w-20 animate-spin text-purple-800" viewBox="0 0 256 256">
